...
export const ENV = {
  ...
  WORKSPACE: {
    ...
    CONFIG_DIR: getEnvString('OPENCODE_CONFIG_DIR', DEFAULTS.WORKSPACE.CONFIG_DIR),
    AUTH_FILE: getEnvString('OPENCODE_AUTH_FILE', DEFAULTS.WORKSPACE.AUTH_FILE),
    CONFIG_SYNC_MODE: getEnvString('OPENCODE_CONFIG_SYNC_MODE', DEFAULTS.WORKSPACE.CONFIG_SYNC_MODE) as 'db-to-file' | 'file-to-db' | 'none',
  },
