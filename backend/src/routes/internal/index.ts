...
import { createInternalOpenCodeConfigRoutes } from './opencode-config'
...
export function createInternalRoutes(
  ...
  app.route('/opencode-config', createInternalOpenCodeConfigRoutes(settingsService, openCodeClient))
