...
describe('LoopService', () => {
  ...
  test('listActive returns only active states', () => {
    const activeState1 = {
      ...
      workspaceId: 'wrk_loop_worktree-1',
      iteration: 1,
      maxIterations: 0,
      completionPromise: null,
      startedAt: new Date().toISOString(),
    ...
    const activeState2 = {
      ...
      workspaceId: 'wrk_loop_worktree-2',
      iteration: 2,
      maxIterations: 0,
      completionPromise: null,
      startedAt: new Date().toISOString(),
    ...
    const inactiveState = {
      ...
      workspaceId: 'wrk_loop_worktree-3',
      iteration: 1,
      maxIterations: 0,
      completionPromise: null,
      startedAt: new Date().toISOString(),
  ...
  test('findByWorktreeName returns state by worktree name', () => {
    const state1 = {
      ...
      workspaceId: 'wrk_loop_unique-worktree-name',
      iteration: 1,
      maxIterations: 0,
      completionPromise: null,
      startedAt: new Date().toISOString(),
